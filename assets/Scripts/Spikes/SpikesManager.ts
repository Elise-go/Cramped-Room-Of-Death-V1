...
import { ENTITY_STATE_ENUM, ENTITY_TYPE_ENUM, EVENT_ENUM, PARAMS_NAME_ENUM, SPRIKES_TYPE_MAP_TOTAL_CLIPS_ENUM } from '../../Enums';
...
export class SpikesManager extends Component {
    ...
    set clip(newClip:number){
        this._clip = newClip;
        this.fsm.setParamsValue(PARAMS_NAME_ENUM.SPIKES_CUR_CLIP, newClip);
    }
    ...
    set totalClips(newClips:number){
        ...
        this.fsm.setParamsValue(PARAMS_NAME_ENUM.SPIKES_TOTAL_CLIPS, newClips);
    }
